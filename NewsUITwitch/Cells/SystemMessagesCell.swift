...
class SystemMessagesCell: UICollectionViewCell {
    ...
    let icon: UIImageView = {
        let v = UIImageView(image: UIImage(named: "system.png"), highlightedImage: nil)
