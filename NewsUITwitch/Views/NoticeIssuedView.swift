...
class NoticeIssuedView: UIView {
    ...
    func setupViews() {
        ...
        dashedView.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 5, paddingLeft: 30, paddingBottom: 24, paddingRight: 30, width: 0, height: 0)
